...
<div>
  <div class="container overview">
    <div class="row" style="margin-top: 20px">
      <div class="col-auto">
        <img src="../images/img2.png" alt="img" style="max-width: 700px" />
      </div>
      <div class="col-md-4 block">
        <h2 class="paintingtitle">Wind blue 0912</h2>
        <h3 class="author">Mark Wood</h3>
        <h4>United States</h4>
        <h4 class="paintingtype">Craft work</h4>
        <h4>Size: 35 W x 50 H x 1.5 D in</h4>

        <h4 class="price">$ 3,700</h4>
        <h4>Buy now</h4>
