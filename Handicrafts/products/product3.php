...
<div>
  <div class="container overview">
    <div class="row" style="margin-top: 20px">
      <div class="col-auto">
        <img src="../images/img3.png" alt="img" style="max-width: 700px" />
      </div>
      <div class="col-md-4 block">
        <h2 class="paintingtitle">Riverside 1902 Painting</h2>
        <h3 class="author">Max Pinkpan</h3>
        <h4>United States</h4>
        <h4 class="paintingtype">Craftwork</h4>
        <h4>Size: 30 W x 24 H x 1.5 D in</h4>

        <h4 class="price">$ 2,300</h4>
        <h4>Buy now</h4>
