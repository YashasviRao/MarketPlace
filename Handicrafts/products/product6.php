...
<div>
  <div class="container overview">
    <div class="row" style="margin-top: 20px">
      <div class="col-auto">
        <img src="../images/img6.png" alt="img" style="max-width: 700px" />
      </div>
      <div class="col-md-4 block">
        <h2 class="paintingtitle">River Land Meets 9012 Painting</h2>
        <h3 class="author">Sam Curry</h3>
        <h4>United States</h4>
        <h4 class="paintingtype">Painting, Acrylic on Canvas</h4>
        <h4>Size: 30 W x 24 H x 1.5 D in</h4>

        <h4 class="price">$ 3,800</h4>
        <h4>Buy now</h4>
