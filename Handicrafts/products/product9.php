...
$title = "Blue vibes 3012 Painting";
...
<div>
  <div class="container overview">
    <div class="row" style="margin-top: 20px">
      <div class="col-auto">
        <img src="../images/img9.png" alt="img" style="max-width: 700px" />
      </div>
      <div class="col-md-4 block">
        <h2 class="paintingtitle">Blue vibes 3012 Painting</h2>
        <h3 class="author">Jason Momoa</h3>
        <h4>United States</h4>
