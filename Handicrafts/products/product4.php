...
<div>
  <div class="container overview">
    <div class="row" style="margin-top: 20px">
      <div class="col-auto">
        <img src="../images/img4.png" alt="img" style="max-width: 700px" />
      </div>
      <div class="col-md-4 block">
        <h2 class="paintingtitle">Antique 301</h2>
        <h3 class="author">Sham Shrivastav</h3>
        <h4>India</h4>
        <h4 class="paintingtype">Craftwork</h4>
        <h4>Size: 34 W x 24 H x 1.5 D in</h4>
