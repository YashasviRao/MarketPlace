...
<div>
  ...
  <div class="container overview">
    <div class="row" style="margin-top: 20px">
      <div class="col-auto">
        <img src="../images/img1.png" alt="img" style="max-width: 700px" />
      </div>
      <div class="col-md-4 block">
        <h2 class="paintingtitle">LordGanesha craftwork</h2>
        <h3 class="author">Venkateshwara Rao</h3>
        <h4>India</h4>
        <h4 class="paintingtype">Coloured Wooden Carving</h4>
        <h4>Size: 30 W x 24 H x 1.5 D in</h4>

        <h4 class="price">$ 1,500</h4>
        <h4>Purchase now</h4>
