        ...
        <div class="contact-page">
            <div class="container">
                <div class="row">
                    ...
                    <h3 class="widget-title">Register User</h3>
                        <div class="contact-form">
                            <form name="contactform" id="contactform" action="user2.php" method="post">
                                <p>
                                    <input name="fname" type="text" id="fname" placeholder="Your First Name">
                                </p>
                                <p>
                                    <input name="lname" type="text" id="lname" placeholder="Your Last Name">
                                </p>
                                <p>
                                ...
                                <p>
                                    <input name="mobile" type="tel" id="mobile" placeholder="Your Mobile Number"> 
                                </p>
